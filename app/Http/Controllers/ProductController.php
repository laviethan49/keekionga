...
class ProductController extends Controller
{
    ...
    public function sendEmailForInquiry(Request $req)
    {
		...
		Mail::to('clayton.spinney@yahoo.com')->cc($req->user_email)->bcc('laviethan49@gmail.com')->send(new KeekiongaMail($req->user_name, $req->user_phone, $req->user_comment, $req->grocery_item, $req->total));
